...
PARAMS = {
    ...
    Product.SQUID_INK: {
        "take_width": take_width_to_be_changed,
        "clear_width": clear_width_to_be_changed,
        "prevent_adverse": True,
        "adverse_volume": adverse_volume_to_be_changed,
        "reversion_beta": reversion_beta_to_be_changed,
        "disregard_edge": disregard_edge_to_be_changed,
        "join_edge": join_edge_to_be_changed,
        "default_edge": default_edge_to_be_changed,

        "z_rolling_window": z_rolling_window_to_be_changed,     # number of ticks to consider for the rolling average
        "zscore_threshold": zscore_threshold_to_be_changed,  # threshold for taking advantage of large swings
    },
